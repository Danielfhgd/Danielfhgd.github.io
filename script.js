...
function trazarRuta() {
    ...
    if (!escaleraSeleccionadaGlobal && pisoO !== pisoD) {
        ...
        // Sincronización con las nuevas llaves del JSON
        const escIzqO = (pisoO === "Piso 1") ? datosMapa[pisoO]["Ala Izquierda"]["escSotano"] : datosMapa[pisoO]["Ala Izquierda"]["escalera_izquierda"];
        const escDerO = (pisoO === "Piso 1") ? datosMapa[pisoO]["Ala Derecha"]?.["escSotanoD"] : datosMapa[pisoO]["Ala Derecha"]?.["escalera_derecha"];
        
        const escIzqD = (pisoD === "Piso 1") ? datosMapa[pisoD]["Ala Izquierda"]["escSotano"] : datosMapa[pisoD]["Ala Izquierda"]["escalera_izquierda"];
        const escDerD = (pisoD === "Piso 1") ? datosMapa[pisoD]["Ala Derecha"]?.["escSotanoD"] : datosMapa[pisoD]["Ala Derecha"]?.["escalera_derecha"];
    ...
    if (pisoVista === pisoO && pisoVista !== pisoD) {
        ...
        pB = (escaleraSeleccionadaGlobal === "IZQUIERDA") 
            ? (datosMapa[pisoVista]["Ala Izquierda"]["escSotano"] || datosMapa[pisoVista]["Ala Izquierda"]["escalera_izquierda"])
            : (datosMapa[pisoVista]["Ala Derecha"]["escSotanoD"] || datosMapa[pisoVista]["Ala Derecha"]["escalera_derecha"]);
...
function gestionarClicMapa(event) {
    ...
    const nombre = prompt("Nombre de ubicación:");
    const ala = prompt("Ala/Zona:", "Ala Izquierda");
    
    if (nombre && ala) {
        if (!datosMapa[piso][ala]) datosMapa[piso][ala] = {};
        datosMapa[piso][ala][nombre] = { x, y };
