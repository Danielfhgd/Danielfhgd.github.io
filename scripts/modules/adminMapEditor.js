...
class AdminMapEditor {
    ...
    async confirmarAgregar() {
        ...
        // Determinar clave interna del sector (mapeo temprano para evitar duplicados vacíos)
        let targetSector = sector;
        if (sector === 'Ala_Este') targetSector = 'ala-este';
        else if (sector === 'Ala_Oeste') targetSector = 'ala-oeste';
        else if (sector === 'Centro') targetSector = 'centro';
